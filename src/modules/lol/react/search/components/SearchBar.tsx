...
import { useSearchBarItems } from "@root/modules/lol/react/search/hook/use-search-bar.hook";
...
export default function SearchBar({
  ...
  const { query, setQuery, handleSubmit } = useSearchBarItems({ onSearch });
  ...
  return (
    <form ref={ref} onSubmit={onSubmit} className="relative w-full mt-8 mx-auto bg-white">
      <Command
      ...
      >
        <CommandInput
          ...
          placeholder="Chercher un objet (ex: AP, Épée, Bottes...)"
        />
